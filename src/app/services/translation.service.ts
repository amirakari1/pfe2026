...
export class TranslationService {
  ...
  private translations: { [lang: string]: Translation } = {
    en: {
      ...
      'game.sugar.description': 'A drink is shown. Guess how many sugar cubes it contains (0-15).',
      ...
      'game.sugar.alternative': 'Healthier alternative: Water + fruits',
      'game.sugar.next': 'Next Drink',
      'game.sugar.drink.cola': 'Coca-Cola',
      'game.sugar.drink.juice': 'Orange Juice (industrial)',
      'game.sugar.drink.energy': 'Energy Drink',
      'game.sugar.drink.smoothie': 'Fruit Smoothie (store)',
      'game.sugar.drink.soda': 'Lemon Soda',
    ...
    ar: {
      ...
      'game.sugar.description': 'يُعرض لك مشروب. خمّن كم مكعب سكر يحتوي (من 0 إلى 15).',
      ...
      'game.sugar.alternative': 'بديل صحي: ماء + فواكه',
      'game.sugar.next': 'المشروب التالي',
      'game.sugar.drink.cola': 'كوكاكولا',
      'game.sugar.drink.juice': 'عصير برتقال (صناعي)',
      'game.sugar.drink.energy': 'مشروب طاقة',
      'game.sugar.drink.smoothie': 'سموذي فواكه (جاهز)',
      'game.sugar.drink.soda': 'صودا ليمون',
